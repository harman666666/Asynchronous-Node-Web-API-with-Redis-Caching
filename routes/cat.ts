...
module.exports = function(app:Express){
    ...
    app.post('/cat', function (req, res) {
        ...
        newCat.save(function (err) { //tell model to save itself, callback function whether or not it 
                                    //happened
  ...
  "data": [
    ...
    app.get('/cat', function (req, res) {
        Cat.find(function (err, cats) {//pass in cats object, finds all the cats
