...
module.exports = function(app:Express){
    ...
    app.post('/dog', function (req, res) {
        ...
        newdog.save(function (err) { //tell model to save itself, callback function whether or not it 
                                    //happened
...
/* Read */
    ...
    app.get('/dog', function (req, res) {
        dog.find(function (err, dogs) {//pass in dogs object, finds all the dogs
